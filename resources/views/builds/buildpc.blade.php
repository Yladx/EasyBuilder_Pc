                ...
                <div class="d-flex justify-content-between align-items-center sticky-header">
                    ...
                    <div class="motherboard-components px-4 mt-4">
                        ...
                        <div class="component-item flex-shrink-0 mb-3"
                            ...
                            data-ram-slots="{{ $motherboard->ram_slots ?? 0 }}">
...
>  <box-icon name='chevrons-left' animation='burst' ></box-icon>
   ...
   <script src="{{ asset('js/buildpc/buildpc-modal.js') }}"></script>
 <!-- Add SweetAlert and JavaScript -->
 <script src="{{ asset('js/buildpc/buildpc-faq.js') }}"></script>

 <!-- Add JavaScript for component selection -->
 <script src="{{ asset('js/buildpc/buildpc-utils.js') }}"></script>
 <script src="{{ asset('js/buildpc/buildpc-components.js') }}"></script>

 <script src="{{ asset('js/buildpc/buildpccompatability-user.js') }}"></script>
