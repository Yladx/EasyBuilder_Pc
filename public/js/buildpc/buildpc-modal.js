...
class PublishManager {
    ...
    initializeEventListeners() {
        ...
        const publishModal = document.getElementById('publishBuildModal');
        if (publishModal) {
            publishModal.addEventListener('hidden.bs.modal', () => {
    ...
    async saveBuild() {
        ...
        try {
            ...
            // First hide the modal and remove backdrop
            const modal = document.getElementById('publishBuildModal');
