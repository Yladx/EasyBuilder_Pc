    ...
    updateSelectedComponentsDisplay() {
        ...
        Object.entries(this.selectedComponents).forEach(([type, component]) => {
            ...
            components.forEach(comp => {
                ...
                const imgSrc = comp.imgSrc || '/placeholder.png';
                div.innerHTML = `
                    <img src="${imgSrc}" alt="${comp.name}" class="component-thumbnail">
                    <span class="ms-2">${type.charAt(0).toUpperCase() + type.slice(1)}: ${comp.name}</span>
                `;
